...
<loginTicketRequest version="1.0">
  ...
  <service>wsfe</service>
    ...
    return {
      ...
      certificadoCargado: !!configARCA.certificado,
      claveCargada: !!configARCA.clavePrivada
    };
...
async function procesarFacturacion(pedidoId) {
  try {
    ...
    const factura = await generarFacturaAFIP(pedido, pedido.tipo_factura || 'CF');
...
module.exports = { router, procesarFacturacion };